...
function showOld(){
        ...
        appendFields1 +='<td><input type="number" class="w3-input w3-transparent" placeholder="Voted value"></td>';
        appendFields1 +='<td><input type="number" class="w3-input w3-transparent" placeholder="Amount bided"></td>';
        appendFields1 += '</tr>';
